...
--
-- Host: localhost    Database: render_db
-- ------------------------------------------------------
...
CREATE TABLE `users` (
  ...
  `longtidude` float DEFAULT NULL,
  `lastidude` float DEFAULT NULL,
  `bandwidth` float DEFAULT NULL,
  `gpu_total` float DEFAULT NULL,
  `gpu_name` varchar(100) DEFAULT NULL,
  `rammemory` float DEFAULT NULL,
...
-- Dump completed on 2024-03-14 18:03:00
